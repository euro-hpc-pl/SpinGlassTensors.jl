function contract_tensor3_matrix(B::Array{T, 3}, C::DiagonalTensor{T}) where T <: Real
...
function contract_matrix_tensor3(C::DiagonalTensor{T}, B::Array{T, 3}) where T <: Real
