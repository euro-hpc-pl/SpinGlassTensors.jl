...
function contract_tensor3_matrix(B::ArrayOrCuArray{R, 3}, C::DiagonalTensor{R}) where R <: Real
...
function contract_matrix_tensor3(C::DiagonalTensor{R}, B::ArrayOrCuArray{R, 3}) where R <: Real
