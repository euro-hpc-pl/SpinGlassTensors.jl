function attach_central_left(B::Array{T, 3}, C::DiagonalTensor{T}) where T <: Real
...
function attach_central_right(B::Array{T, 3}, C::DiagonalTensor{T}) where T <: Real
...
function _project_on_border(K::Array{T, 1}, M::DiagonalTensor{T}) where T <: Real
